...
setup(
    ...
    description="Megamicros Mems array library",  # Optional
    ...
    url="https://github.com/bimea/megamicros",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="Bruno Gas",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="bruno.gas@sorbonne-universite.fr",  # Optional
    ...
    # larger catalog.
    keywords="MEMs, antenna, beamforming, IA",  # Optional
